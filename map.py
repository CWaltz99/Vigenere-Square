...
class Map:
    ...
    def __len__(self):
        ...
        This allows you to find the number of items in the Met
        with len(mapA)
        """
    ...
    def __contains__(self, key):
        ...
        and False, otherwise.
        This allows you to code: if key in mapA
        """
    ...
    def find_index(self, key):
        """
        Returns the index in the list holding the keys of a 
        passed in key, or None, if the key is not in the map
        """
...
class MapIterator:
    ...
    def __next__(self):
        """
        Walk the Python list to return the next entry in the map
        """
